...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Ángel Álvarez" },
      ...
      { property: "profile:first_name", content: "Jesús Ángel" },
      { property: "profile:last_name", content: "Álvarez González" },
